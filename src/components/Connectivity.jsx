import port from "../assets/port connection new Ports 1.webp";
import usbMbl from "../assets/usbMbl.webp";


const Connectivity = () => {
  return (
    <>
      <div className="flex flex-col items-center text-center lg:mb-30">
