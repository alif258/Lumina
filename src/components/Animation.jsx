  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      accordionData.forEach((_, index) => {
        ...
        // Minimal content animation - only opacity and height
        ...
        // Minimal button wrapper animation
    ...
    <div className="flex items-center justify-center py-8 sm:py-10 md:py-14 lg:py-20 px-4 sm:px-6 md:px-10 lg:px-0">
      ...
      >
            ...
            <div key={index} className="group hidden md:block">
              ...
              >
                <button
                  ...
                  className="relative flex items-center space-x-2 lg:space-x-3 text-lg lg:text-xl xl:text-2xl backdrop-blur-md font-semibold text-[#3B3A3A] px-3 lg:px-4 rounded-2xl lg:rounded-3xl bg-white/60 py-2 lg:py-2.5 ml-1 lg:ml-2 leading-[139.1%] mt-2 lg:mt-3 overflow-hidden transition-all duration-500 ease-out hover:bg-white/90 "
                  onMouseEnter={(e) => {
                ...
                >
                  ...
                  <span className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/50 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out"></span>
                  
                  <span className="text-lg lg:text-xl xl:text-2xl font-light relative z-10 transition-all duration-700 ease-out group-hover:rotate-90 group-hover:scale-110">
                    <FiPlusCircle />
                  </span>
                  <span className="relative z-10 transition-all duration-300">{item.buttonTitle}</span>
                </button>
              </div>
        ...
        <div className="hidden md:flex absolute left-4 lg:left-6 top-1/2 -translate-y-1/2 flex-col space-y-2 z-10">
          <button
            className="p-1.5 lg:p-2 bg-white/40 backdrop-blur-sm rounded-full hover:bg-black hover:text-white transition-all duration-500 hover:scale-110 active:scale-95 hover:shadow-lg"
            onClick={() =>
