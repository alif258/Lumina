...
const LaptopDetails = () => {
    return (
<div className="w-full flex flex-col gap-10 md:gap-15 py-15 md:py-42 px-8 md:px-0
    ...
    /* Desktop: Desktop image background */
    md:bg-[url('./assets/bg01.png')] md:bg-center md:bg-cover md:min-h-screen">
    
    {/* Section 01 */}
    <div className="div01 max-w-[1420px] m-auto flex flex-col md:flex-row items-center gap-10 md:gap-12">
        <div className="text w-full md:w-[50%]">
            ...
            <h2 className='text-center md:text-start text-[27px] md:text-[48px] font-bold text-[#313030] leading-tight'>Protective Cover with <br className="hidden md:block" /> Integrated Stand</h2>
    ...
    {/* Section 02 */}
    <div className="div03 max-w-[1420px] m-auto flex flex-col-reverse md:flex-row items-center gap-10 md:gap-12">
        <div className="img w-full md:w-[50%]">
    ...
    {/* Section 03 */}
    <div className="div02 max-w-[1420px] m-auto flex flex-col md:flex-row items-center gap-10 md:gap-12">
        <div className="text w-full md:w-[50%]">
