import back from "../assets/back stand 4.webp";
import Lania from "../assets/Lania N95 with Lumina 15 1.webp";
import Usb from "../assets/Usb C port connection 4.webp";
...
<div className="w-full flex flex-col gap-10 md:gap-12 lg:gap-15 xl:gap-15 py-15 md:py-28 lg:-mt-35 lg:-mb-10 lg:py-50 xl:py-50 px-6 md:px-10 lg:px-0
    ...
    <div className="div01 max-w-[1420px] m-auto flex flex-col md:flex-row items-center gap-10 md:gap-10 lg:gap-12">
        <div className="text w-full md:w-[45%]">
        ...
        <div className="img w-full md:w-[55%]">
    ...
    <div className="div02 max-w-[1420px] m-auto flex flex-col md:flex-row items-center gap-10 md:gap-10 lg:gap-12">
        ...
        <div className="img w-full md:w-[60%]">
