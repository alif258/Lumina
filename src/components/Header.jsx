  ...
  return (
    <div className="w-full mx-auto lg:min-h-screen">
      ...
      <div className="flex justify-center mt-6 md:mt-8 lg:mt-10 mb-8 lg:mb-15">
        <button className="p-0.75 rounded-full gradient-bg box-7 transition-transform  shadow-xl">
          <div className=" px-8 py-3 md:px-12 lg:px-10 md:py-3 lg:py-3 rounded-full bg-[#F0F3FE]">
            <span className="text-[16px] md:text-[18px] lg:text-[20px] font-semibold text-black uppercase ">
              Buy Now
            </span>
          </div>
        </button>
