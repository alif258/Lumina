...
const LaptopCart = () => {
 ...
 <div className="px-6  md:px-0">
   <div className='bg-[#E8ECF9] rounded-2xl p-6 pb-0 max-w-355 m-auto mt-16 flex flex-col md:flex-row justify-between gap-10 md:gap-12'>
    ...
    <div className="img w-full md:w-[60%] flex flex-col items-center ">
      <div className="icon flex flex-wrap justify-center md:justify-start gap-5 md:gap-6 md-0 md:mt-10">
        ...
        <div className="bg-[#EAEDFA] py-2 md:py-3 px-3 md:px-4.5 rounded-2xl flex items-center gap-2 border border-[#D1D5F6]">
          <img src={Ellipse2} alt="" className="w-4 h-4 md:w-auto md:h-auto" />
          <p className='text-[14px] md:text-[16px] font-semibold text-[#303031]'>1920 X 1080</p>
        </div>
        <div className="Viewing bg-[#EAEDFA] py-2 md:py-3 px-3 md:px-4.5 rounded-2xl flex items-center gap-2 border border-[#D1D5F6]">
          <img src={Ellipse3} alt="" className="w-4 h-4 md:w-auto md:h-auto" />
          <p className='text-[14px] md:text-[16px] font-semibold text-[#303031]'>178° Viewing Angle</p>
        </div>
      </div>
      <div className="img w-full mt-6 md:mt-4">
        <img src={FullHD} alt="Full HD Display" className="w-full h-auto object-contain hidden md:block" />
        <img src={full} alt="Full HD Display" className="w-full h-auto object-contain md:hidden" />
      </div>
    </div>
  </div>

  <div className='bg-[#E8ECF9] rounded-3xl p-6 max-w-355 m-auto mt-16 flex flex-col-reverse md:flex-row items-center justify-between gap-7 '>
  ...
  <div className="m-auto max-w-355 mt-16 flex gap-10 md:gap-15 justify-between flex-col md:flex-row px-6 md:px-0">
    <div className="left gradient-bg box-2 rounded-2xl w-full py-10 md:py-20 px-6 md:px-14">
      <div className="flex items-center gap-4 md:gap-2">
        <div className="img shrink-0">
          <img src={low} alt="Low Blue Light" className="w-10 md:w-auto" />
        </div>
        <div className="text flex flex-col">
          <h3 className='text-[22px] md:text-[32px] font-bold text-[#010101]'>Low Blue Light Mode</h3>
          <p className='text-[14px] md:text-[18px] text-[#4E4D4D]'>Comfortable viewing for long hours</p>
        </div>
      </div>
      <p className='mt-6 md:mt-9 text-[16px] md:text-[24px] text-[#4E4D4D]'>
        Low Blue Light Mode helps protect your eyes and keeps viewing comfortable, even after extended use.
      </p>
    </div>

    <div className="Right gradient-bg box-1 rounded-2xl w-full py-10 md:py-20 px-6 md:px-14">
      <div className="flex items-center gap-4 md:gap-2">
        <div className="img shrink-0">
          <img src={truecolor} alt="True Color" className="w-10 md:w-auto" />
        </div>
        <div className="text flex flex-col">
          <h3 className='text-[22px] md:text-[32px] font-bold text-[#010101]'>True Color Display</h3>
          <p className='text-[14px] md:text-[18px] text-[#4E4D4D]'>Enjoy precise color accuracy</p>
        </div>
      </div>
      <p className='mt-6 md:mt-9 text-[16px] md:text-[24px] text-[#4E4D4D]'>
