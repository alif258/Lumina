...
const LaptopCart = () => {
 ...
 <div className="px-6 md:px-10 lg:px-0">
   <div className='shadow-lg bg-[#E8ECF9] rounded-2xl p-6 pb-0 max-w-355 m-auto mt-16 flex flex-col md:flex-row justify-between gap-10 md:gap-10 lg:gap-12'>
    <div className="text gradient-bg box-4 mb-6 rounded-2xl py-12 md:py-16 lg:py-20 px-8 md:px-10 lg:px-13 w-full md:w-[45%]">
    ...
    <div className="img w-full md:w-[55%] flex flex-col md:justify-center lg:justify-between items-center">
      <div className="icon flex flex-wrap justify-center gap-5 md:gap-5 lg:gap-6 md:mt-6 lg:mt-10 lg:mb-5">
  ...
  <div className='shadow-lg bg-[#E8ECF9] rounded-3xl p-6 max-w-355 m-auto mt-16 flex flex-col-reverse md:flex-row items-center justify-between gap-7 md:gap-6 lg:gap-7'>
  ...
  <div className="m-auto max-w-355 mt-16 flex gap-10 md:gap-12 lg:gap-15 justify-between flex-col md:flex-row px-6 md:px-10 lg:px-0">
    <div className="left gradient-bg box-2 rounded-2xl w-full py-10 md:py-12 lg:py-12 px-6 md:px-10 lg:px-14">
      ...
      <p className='mt-6 md:mt-7 lg:mt-4 text-[16px] md:text-[20px] lg:text-[24px] text-[#4E4D4D]'>
        Low Blue Light Mode helps protect your eyes and keeps viewing comfortable, even after extended use.
      </p>
    </div>

    <div className="Right gradient-bg box-1 rounded-2xl w-full py-10 md:py-12 lg:py-12 px-6 md:px-10 lg:px-14">
      <div className="flex items-center gap-4 md:gap-3 lg:gap-2">
        <div className="img shrink-0">
