...
const LaptopCart = () => {
  return (
    <>
      ...
      <div className="m-auto max-w-355 mt-16 flex gap-15 justify-between ">
        <div className="left gradient-bg box-2 rounded-2xl  w-full py-20 px-14">
          <div className="flex items-center gap-2">
            <div className="img ">
              <img src={low} alt="" />
            </div>
            <div className="text flex flex-col gap-1.5">
              <h3 className='text-[32px] font-bold text-[#010101]'>Low Blue Light Mode</h3>
              <p className='text-[18px] text-[#4E4D4D]'>Comfortable viewing for long hours</p>
            </div>
          </div>
          <p className='mt-9 text-[24px] text-[#4E4D4D]'>Low Blue Light Mode helps protect your eyes and keeps viewing comfortable, even after extended use.</p>
        </div>




        <div className="Right gradient-bg box-1 rounded-2xl w-full  py-20 px-14">
          <div className="flex items-center gap-2">
            <div className="img ">
              <img src={truecolor} alt="" />
            </div>
            <div className="text flex flex-col gap-1.5">
              <h3 className='text-[32px] font-bold text-[#010101]'>True Color Display</h3>
              <p className='text-[18px] text-[#4E4D4D]'>Enjoy precise color accuracy</p>
            </div>
          </div>
          <p className='mt-9 text-[24px] text-[#4E4D4D]'>True Color Display ensures consistent and natural colors wherever you work or play.</p>
        </div>
      </div>
