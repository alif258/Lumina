...
const Bags = () => {
  ...
  <div
  className="bg-[url('./assets/Mblbags.png')] xl:bg-[url('./assets/bag.png')] bg-no-repeat bg-cover xl:bg-contain bg-center xl:bg-bottom max-w-355 m-auto h-140 md:h-[600px] lg:h-140 xl:h-90.5 flex flex-col justify-start xl:justify-end items-center xl:items-start pt-10 xl:pt-0 md:pb-8 lg:pb-10 xl:pl-8 px-8 text-center xl:text-left rounded-3xl overflow-hidden"
>
  {/* Heading */}
