...
import MaskGroupMbl from "../assets/MaskGroupMbl.webp";

const Uniform = () => {
  return (
    <>
      <div className="flex flex-col items-center mt-20 md:mt-28 lg:mt-40 max-w-355 m-auto px-6 md:px-10 lg:px-0">
        <h2 className="text-[28px] md:text-[38px] lg:text-[48px] font-bold text-[#78797F] text-center leading-tight">
          Uniform Visuals from{" "}
          <span className="text-[#3C3C3D]">Every Angle</span>
        </h2>

        <p className="leading-[140%] mt-4 md:mt-5 lg:mt-6 mb-8 md:mb-9 lg:mb-11 text-center text-[16px] md:text-[20px] lg:text-[24px] text-[#353434] max-w-355">
        ...
        <div className="flex flex-row gap-10 md:gap-60 lg:gap-100">
          <div className="left items-center flex justify-center text-center flex-col">
            <h5 className="text-[24px] md:text-[32px] lg:text-[36px] font-bold text-black">
              1920 X 1080
            </h5>
            <p className="text-[14px] md:text-[18px] lg:text-[20px] font-medium text-[#464646]">
              Resolution
            </p>
          </div>
